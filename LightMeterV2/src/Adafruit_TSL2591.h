// Copyright 2014 KT0WN (Adafruit Industries)
/**************************************************************************/
/*!
...
#ifndef LIGHTMETERV2_SRC_ADAFRUIT_TSL2591_H_
#define LIGHTMETERV2_SRC_ADAFRUIT_TSL2591_H_
...
#define TSL2591_ENABLE_AIEN \
    (0x10)  ///< ALS Interrupt Enable. When asserted permits ALS interrupts to
            ///< be generated, subject to the persist filter.
#define TSL2591_ENABLE_NPIEN \
    (0x80)  ///< No Persist Interrupt Enable. When asserted NP Threshold
            ///< conditions will generate an interrupt, bypassing the persist
            ///< filter
...
class Adafruit_TSL2591 : public Adafruit_Sensor {
 public:
    Adafruit_TSL2591(int32_t sensorID = -1);  // NOLINT
...
#endif  // LIGHTMETERV2_SRC_ADAFRUIT_TSL2591_H_
