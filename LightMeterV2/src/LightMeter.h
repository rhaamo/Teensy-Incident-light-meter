 ...
 *
 * Full: 22, 20, 18, 16, 14, 13, 11, 10, 10.5, 9, 8, 7.1, 6.3, 5.6, 5, 4.5,
 * 4, 3.8, 3.5, 3.2, 2.8, 2.5, 2.2, 2, 1.9, 1.8, 1.4
 */
...
const float fStopTable[FSTOP_COUNT] = {
    1.4, 1.8, 1.9, 2, 2.2, 2.5,  2.8, 3.2, 3.5, 3.8, 4,  4.5, 5, 5.6,
    6.3, 7.1, 8,   9, 10,  10.5, 11,  13,  14,  16,  18, 20,  22};
...
const float isoTable[ISO_COUNT] = {25,  100,  125,  200, 400,
                                   800, 1600, 3200, 6400};
